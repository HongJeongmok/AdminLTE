...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<header class="main-header">
			<!-- Logo -->
			<a href="../main/index.jsp" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
						...
						<li class="dropdown user user-menu"><a href="#"
							...
							<ul class="dropdown-menu">
								...
								<li class="user-header"><img
									src="<%=contextPath%>/resources/dist/img/user2-160x160.jpg" class="img-circle"
									alt="User Image">
