              ...
              <div class="tab-pane" id="settings">
                <form class="form-horizontal" action="profile.do" method="post">
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="email" class="form-control" name="email" placeholder="Email" value="${authUser.id}">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="name" placeholder="Name" value="${authUser.name}">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="password" class="form-control" id="password" name="curPwd" placeholder="Password">
                    </div>
                  </div>
                  
                  <div class="form-group">
                    <label for="inputName" class="col-sm-2 control-label">ChangePassword</label>
                    <div class="col-sm-10">
                      <input type="password" class="form-control" id="Confirmpassword" name="newPwd" placeholder="ChangePassword">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                      <div>
                        <label>
                        	<c:if test="${errors.curPwd}">현재 암호를 입력하세요.<br></c:if>
                        	<c:if test="${errors.badCurPwd}">현재 암호가 일치하지 않습니다.<br></c:if>
                        	<c:if test="${errors.newPwd}">새 암호를 입력하세요.<br></c:if>
