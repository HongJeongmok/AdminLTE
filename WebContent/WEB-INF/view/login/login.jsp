...
<body class="hold-transition login-page">
	<div class="login-box">
		<div class="login-logo">
			<a href="../../index2.html"><b>JAVA</b> world</a>
		</div>
		<!-- /.login-logo -->
		<div class="login-box-body">
			<p class="login-box-msg">로그인 후 이용해주세요.<br>
				<c:if test="${errors.idOrPwNotMatch}">아이디와 암호가 일치하지 않습니다.<br></c:if>
				<c:if test="${errors.memberID}">아이디를 입력하세요.<br></c:if>
				<c:if test="${errors.password}">암호를 입력하세요.</c:if>
			</p>

			<form action="${pageContext.request.contextPath}/login.do" method="post">
				<div class="form-group has-feedback">
					<input type="email" class="form-control" name="memberID" value="${param.memberID}"
			...
			<a href="#">비밀번호 찾기</a><br> <a href="${pageContext.request.contextPath}/join.do"
