...
<body class="hold-transition skin-blue sidebar-mini">
							...
							<ul class="dropdown-menu">
								...
								<li class="user-footer">
									...
									<div class="pull-right">
										<a href="./pages/examples/login.jsp"
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li class="treeview"><a href="#"> <i class="fa fa-folder"></i>
						...
						<ul class="treeview-menu">
							...
							<li><a href="pages/examples/ì¡°ì ë·ì»´.html"><i
									class="fa fa-circle-o"></i> ì¡°ì ë·ì»´</a></li>
							<li><a href="pages/examples/ì¼ë°ê²ìí.html"><i
									class="fa fa-circle-o"></i> ì¼ë°ê²ìí</a></li>
							<li><a href="pages/examples/ëìì¼ë³´.html"><i
									class="fa fa-circle-o"></i> ëìì¼ë³´</a></li>
	...
	<script type="text/javascript" src="build/js/swipe.js"></script>
